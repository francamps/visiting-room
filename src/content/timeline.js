export const TIMELINE = [
  ...
  },
  {
    ...
    paragraphs: [
      {
        element: "p",
        content: `In 1967, the Louisiana legislature increased the
...
people served under the `,
      ...
      { element: "br" },
      {
        element: "p",
        content: `Then,
in the 1970s, after the U.S. Supreme Court struck down
its death penalty statute, the Department of Corrections
halted normal operation of the 10/6 provision and the
Louisiana legislature began imposing harsher
restrictions upon lifers.`,
      },
      { element: "br" },
      {
        element: "p",
...
norm was `,
      ...
      {
        element: "p",
        content: `It was in this era that life
without the possibility of parole (LWOP) in Louisiana
was born.`,
      },
    ],
    image: "image1.png",
...
sentences who are African-American is `,
  ...
  },
  {
    ...
    paragraphs: [
      {
        element: "p",
        content: `At the same time that the lifer population was
skyrocketing, the politics of crime was infecting
governors and their willingness to grant commutations.`,
      },
    ],
    image: "image3.png",
    caption: `This cartoon comes from the September 1982 Angolite article titled "The King's Prerogative" p.72.`,
  },
  {
    year: "1990’s",
    ...
    paragraphs: [
      {
        element: "p",
        content: `As changes to sentencing laws ushered in an era of mass
incarceration, district attorneys and state judiciaries
complained that they were overrun with petitions filed
...
sentences, `,
      ...
      { element: "br" },
      {
        element: "p",
        content: `Even more
problematic was the federal adoption of the
Anti-Terrorism and Effective Death Penalty Act in 1996.
This law imposed strict time limitations and
dramatically reduced the power of federal courts to
correct constitutional violations that occurred in state
cases. Combined with the fact that the State of
Louisiana insists it has no obligation to provide
lawyers to help lifers prepare their petitions, these
laws make it nearly impossible for lifers to correct
injustices or obtain lesser sentences through the
courts.`,
      },
    ],
    image: "image4.jpg",
