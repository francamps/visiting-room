        ...
        paragraphs: [
          {
            ...
            subcontent: `Louisiana sentences more people to life without parole per capita
    ...
    sections: [
      ...
      },
      {
        ...
        `,
          ...
          {
            element: "p",
            content: `. In 1890, a statute was passed to give persons 
          sentenced to life imprisonment ("lifers") eligibility 
          to go before the board and seek a
        `,
          },
          {
            element: "f",
    ...
    sections: [
      ...
      },
      {
        paragraphs: [
          {
            element: "p",
            content: `In 1972, the US Supreme Court struck down the death penalty, declaring it `,
          },
          {
            element: "f",
